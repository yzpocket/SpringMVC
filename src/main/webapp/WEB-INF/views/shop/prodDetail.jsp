...
<script>
	const openPop = function(img) {
		...
		window.open(url, 'imgView', 'width=' + w + 'px, height=' + h
				+ 'px, left=100px, top=100px')
	}//----------------------------
				...
				<tbody>
					<tr>
						<td align="center" width="50%"><a href="#"
							onclick="openPop('${prod.pimage1}')"> <img
								src="resources/product_images/${prod.pimage1}" class="img-fluid"
								style="width: 70%;"> <!-- </a> -->
						</a></td>
						...
						<td align="left" width="50%" style="padding-left: 40px">
							...
							POINT:<b style="color: green">[${prod.point}]</b>POINT<br> <!-- form시작---------- -->
							<form name="frm" id="frm" method="POST">
								<!-- 상품번호를 hidden으로 넘기자------ -->
								<input type="hidden" name="pnum" value="${prod.pnum}"> <input
									type="hidden" name="opnum" value="${prod.pnum}">
								<!-- -------------------------------- -->
					...
					<tr style="border: 0">
						<td align="center"><img
							src="resources/product_images/${prod.pimage2}"
							class="img img-thumbnail" style="width: 70%;"></td>
						<td align="center"><img
							src="resources/product_images/${prod.pimage3}"
							class="img img-thumbnail" style="width: 70%;"></td>
					</tr>
					<tr>
						<td colspan="2">
